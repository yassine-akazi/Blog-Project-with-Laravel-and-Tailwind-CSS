  ...
  <form action="/edit/{{$post->id}}" method="POST">
    ...
    <style>
      ...
      <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
        ...
        <textarea class="description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none" spellcheck="false" placeholder="Describe everything about this post here"  name="body">name="body">{{$post->body}}</textarea>
